...
@TableName(value = "sys_dept", autoResultMap = true) // 由于 SQL Server 的 system_user 是关键字，所以使用 system_users
@Data
...
public class SysDeptDO extends BaseDO {
    ...
    private static final long serialVersionUID = 552788107085502571L;
