...
@TableName(value = "gen_table_column", autoResultMap = true) // 由于 SQL Server 的 system_user 是关键字，所以使用 system_users
@Data
...
public class GenTableColumnDO extends BaseDO {
    ...
    private static final long serialVersionUID = 225877538203205994L;
