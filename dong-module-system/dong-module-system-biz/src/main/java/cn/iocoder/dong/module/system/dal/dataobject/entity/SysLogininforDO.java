...
@TableName(value = "sys_logininfor", autoResultMap = true) // 由于 SQL Server 的 system_user 是关键字，所以使用 system_users
@Data
...
public class SysLogininforDO extends BaseDO {
    ...
    private static final long serialVersionUID = -55294576719728603L;
