...
@TableName(value = "gen_table", autoResultMap = true) // 由于 SQL Server 的 system_user 是关键字，所以使用 system_users
@Data
...
public class GenTableDO extends BaseDO {
    ...
    private static final long serialVersionUID = -55320053905439703L;
