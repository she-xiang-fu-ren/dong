...
import cn.iocoder.dong.framework.sms.core.enums.SmsFrameworkErrorCodeConstants;
import lombok.Data;
...
public class SmsCommonResult<T> extends CommonResult<T> {
    ...
    public static <T> cn.iocoder.dong.framework.sms.core.client.SmsCommonResult<T> error(Throwable ex) {
        cn.iocoder.dong.framework.sms.core.client.SmsCommonResult<T> result = new cn.iocoder.dong.framework.sms.core.client.SmsCommonResult<>();
